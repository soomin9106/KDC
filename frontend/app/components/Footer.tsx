...
const Footer = () => {
    return (
        <footer className="w-full flex flex-col sm:flex-row jusify-center items-center h-full bg-accent/60 shadow-sm py-4 sm:py-20 sm:px-80 space-y-8 sm:space-y-0 sm:space-x-60">
            <div>
